...
| <a name="output_amplify_app_production_branch"></a> [amplify_app_production_branch](#output_amplify_app_production_branch) | The production branch for the Amplify App |
